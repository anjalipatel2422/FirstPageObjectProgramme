...
public class CartSuccessPage extends Util
{
    ...
    private By _HTCOneMiniBlueSuccessMessage =By.xpath("//a[@class='product-name'][contains(text(),'HTC One Mini Blue')]");//path od product in shopping cart
    ...
    public void VerifyThatUserSeeTwoProductInShoppingCartSuccessfully(){
        ...
        waituntilElementToBeVisible(_HTCOneMiniBlueSuccessMessage,50);
        Assert.assertEquals(getText2(_HTCOneMiniBlueSuccessMessage),_ExpectedProductAddToCart2);//compare expected result with actual result
    }

}
//("//table/tbody/tr[2]/td[@class='product'][1]");
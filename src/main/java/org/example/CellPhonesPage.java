...
public class CellPhonesPage extends Util
{
    ...
    public void VerifyThatUserAddTwoProductInCartSuccessfully(){ //create method
        JavaScriptclickonElement(_HTConeM8AddToCart);//click on HTCone add to cart button
        //waituntilElementisclickble(_HTCminiAddToCart,20);

      JavaScriptclickonElement(_HTCminiAddToCart);//click on HTCmini add to cart button
    }
